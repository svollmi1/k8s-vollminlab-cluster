...
resource "github_branch_protection" "main" {
  ...
  pattern = "main"
      ...
      required_status_checks {
        strict   = true
        contexts = ["Validate Kubernetes Manifests", "Security Scan", "Flux Configuration Validation", "Kyverno Policy Validation", "Server-Side Validation with Temporary Namespace", "Integration Test", "Secret Scanning"]
      }
